...
fileprivate struct Exercise_Transition_Step2Layout: View {
    ...
    var body: some View {
        ZStack {
            ...
            .animation(Animation.easeOut(duration: 1.1), value: step1)
            ...
            VStack {
                ...
                .font(.system(size: 50))
                .animation(Animation.easeOut(duration: 1), value: step1)
            }
            .padding(.bottom, 75)
        }
        .font(.largeTitle)
